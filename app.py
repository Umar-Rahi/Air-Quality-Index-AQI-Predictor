    ...
    return jsonify([
        {
            ...
            'data': {'pm25': 8.5, 'pm10': 15.2, 'no2': 12.3, 'so2': 2.1, 'co': 0.4, 'o3': 45.2, 'temperature': 22.5, 'humidity': 55.0}
        },
        {
            'name': 'Moderate Air Quality',
            'data': {'pm25': 25.4, 'pm10': 45.8, 'no2': 35.6, 'so2': 8.2, 'co': 1.2, 'o3': 85.3, 'temperature': 28.1, 'humidity': 68.5}
        },
        {
            'name': 'Unhealthy Air Quality',
            'data': {'pm25': 95.6, 'pm10': 155.2, 'no2': 75.4, 'so2': 25.1, 'co': 8.5, 'o3': 145.8, 'temperature': 35.2, 'humidity': 45.3}
        },
        {
            'name': 'Very Unhealthy Air Quality',
            'data': {'pm25': 185.3, 'pm10': 285.7, 'no2': 125.8, 'so2': 45.6, 'co': 15.2, 'o3': 205.4, 'temperature': 38.7, 'humidity': 35.8}
        }
    ])
...
def health_check():
    ...
    return jsonify({'status': 'healthy', 'model_status': model_status})

# 🔻 Put static file serving route LAST
